...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 160; height: 233; z-index: 9998; display: none"></iframe>');
strFrame='<style>';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=150 bordercolor=#5F8CCD bgcolor=#5F8CCD Author="wayx">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#5F8CCD BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
...
strFrame+='</tr><tr><td Author=meizz align=center colspan=3><input Author=meizz type=button class=button value="清空输入框" title="清空输入框" onclick="parent.clearInput()" ';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px;cursor:hand"></td></tr></table></td></tr></table></div>';
...
//checkDate('2009-09-09','2009-09-08');
