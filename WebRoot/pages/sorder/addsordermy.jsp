			...
			<form action="${base }/servlet/SorderServlet?method=saveSorder" method="post"
				...
				<table border="1" class="table" align="center">
					...
					<tr>
						...
						<td >
							<input type="text" readonly="readonly" name="uname"  id="uname"  value="<%=request.getSession().getAttribute("username") %>">
							<input type="hidden" name="uid" id="uid" value="<%=request.getSession().getAttribute("userid") %>">
					...
					<tr>
						...
						<td  >
								<input type="text" readonly="readonly" name="urealname"  id="urealname" value="<%=request.getSession().getAttribute("urealname") %>" >					
						</td>
					</tr>
					<tr>
						<td >
